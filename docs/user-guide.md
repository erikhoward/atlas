...
```bash
# Linux
wget https://github.com/erikhoward/atlas/releases/download/v2.2.0/atlas-linux-x86_64.tar.gz
tar -xzf atlas-linux-x86_64.tar.gz
sudo mv atlas /usr/local/bin/

# macOS
wget https://github.com/erikhoward/atlas/releases/download/v2.2.0/atlas-macos-x86_64.tar.gz
