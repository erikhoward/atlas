...
1. **Use specific version tags**:
   ```bash
   docker run atlas:2.2.0  # Not atlas:latest
   ```
...
```bash
# Tag image
docker tag atlas:2.2.0 your-registry.azurecr.io/atlas:2.2.0

# Login to Azure Container Registry
az acr login --name your-registry

# Push image
docker push your-registry.azurecr.io/atlas:2.2.0

# Pull on production server
docker pull your-registry.azurecr.io/atlas:2.2.0
```
