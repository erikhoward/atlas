...
docker tag atlas:local yourusername/atlas:2.1.0
...
```bash
docker push yourusername/atlas:2.1.0
...
- **Version tags** (e.g., `v2.1.0`): Builds and pushes with version tags
