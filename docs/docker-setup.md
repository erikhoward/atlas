...
docker tag atlas:local yourusername/atlas:2.4.0
...
```bash
docker push yourusername/atlas:2.4.0
...
- **Version tags** (e.g., `v2.4.0`): Builds and pushes with version tags
